...
class StudentInterfaceTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.classNameLabel.text = registeredCourses[indexPath.row].title
        TeacherService.show(forUID: registeredCourses[indexPath.row].teacherID, completion: {(teacher) in
        
            cell.teacherNameLabel.text = teacher?.name
        })
        
        
        cell.haveTakenClassLabel.text = "X"
